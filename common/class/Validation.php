...
class Validation {
	...
	protected function convert_field( $field ){
		$list = array(
			...
			"price_2" 		=> "Fiyat 2",
			"price_3" 		=> "Fiyat 3",
			"stock_amount" 	=> "Stok Adedi",
			"stock_code" 	=> "Stok Kodu",
			"sale_percent" 	=> "İndirim Oranı",
			"category_id" 	=> "Kategori",
			"category_name" => "Kategori adı",
			"shipment_cost" => "Kargo Ücreti",
			"variant_name"  => "Varyant adı",
			"address" => "Adres",
			"address_name" => "Adres Tanımı",
			"city" => "Şehir",
			"name" => "İsim",
			"phone" => "Telefon",
			"tcno" => "TC Kimlik No",
			...
			"pass_1" => "Şifre 1",
			"pass_2" => "Şifre 2",
			"bayi_tcno" => "TC Kimlik No",
			"bayi_firm_name" => "Firma Adı",
			"bayi_vergi_dairesi" => "Vergi Dairesi",
			"bayi_vergi_no" => "Vergi No"
		);
